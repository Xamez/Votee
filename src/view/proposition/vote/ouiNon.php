...
for ($i = 0; $i < 2; $i++) {
    echo '
    <form class="p-3 rounded-xl w-28 text-white text-center cursor-pointer" style="background-color: #' . ($values[$i] == $note ? "22C55E" : $colors[$i]) . '" method="post" action="frontController.php?controller=proposition&action=createdVote">
