    ...
    <div class="flex flex-row justify-center gap-16">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col">
                ...
                <textarea required name="description" id="description" rows="10" class="border-2 border-main rounded-md max-h-40 resize-none"><?= $utilisateur->getDescription();?></textarea>
            </div>
