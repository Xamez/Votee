<div class="flex flex-col md:flex-row justify-center gap-6 md:gap-16">
    ...
    <div class="flex flex-col">
        ...
        if (ConnexionUtilisateur::getUtilisateurConnecte()->getLogin() == $utilisateur->getLogin()) {
            echo '<a class="relative left-40 bottom-12 flex items-center justify-center w-12 h-12 text-main hover:text-white border-main border-2 button bg-white rounded-3xl p-2" href="./frontController.php?controller=utilisateur&action=updateUtilisateur">
